...
import cn.crabapples.system.sysRoleMenu.dao.mybatis.mapper.SysRoleMenuMapper;
...
public class SysRoleMenuDAO extends ServiceImpl<SysRoleMenuMapper, SysRoleMenu> {
    ...
    public SysRoleMenuDAO(SysRoleMenuMapper mapper) {
        this.mapper = mapper;
    }
...
//     * @return 角色拥有的菜单树
//     */
//    public SysRoleMenu getRoleMenusTree(String id) {
//        SysRoleMenu sysRoleMenus = baseMapper.getRoleMenus(id);
